...
def run_pipe(config, outputfilename = 'gamma.dat', outputpairfile=None, jksamp=None):
    rmin    = config['Rmin'] 
    rmax    = config['Rmax'] 
    nbins   = config['Nbins']
